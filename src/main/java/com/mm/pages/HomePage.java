...
public class HomePage extends CommonAction {
	 ...
	 * Thread.sleep(8000); invisibilityOfLoader(driver);
	 * ExtentReporter.logger.log(LogStatus.INFO,
	 ...
	 * ExtentReporter.logger.log(LogStatus.INFO,
	 * "Click Select. Verify Select Policy Type Window displays");
	 * Thread.sleep(1000); click(driver, Select_Entity, "Select button");
	 * switchToParentWindowfromotherwindow(driver, parentWindow); return new
	 * HomePage(driver); }
	 */

	// Replaciing above method for Add risk TC
	...
	//// Code will select policy type for QA applciation.
