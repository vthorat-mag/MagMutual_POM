...
public class PolicyDetailsPage extends CommonAction {
	...
	//Element repository for Policy Details page.
	...
	// Initialize  page elements in constructor on Policy details page.
	...
	public void updatePolicyDetails() throws InterruptedException {
		...
		enterTextIn(driver, Hosp_Disc_Period_Rating, "2","Hospital Discount period rating");
	...
	// Select Agent from Policy Action drop down and Add Agent information in
	// pop up and save Agent
	public void addAgent() throws InterruptedException {
		...
		Thread.sleep(3000);
		selectDropdownByVisibleText(driver, Producer,
				"AB Risk Specialist, Inc. (AG00045, Med. Mal. PL, 02/17/2015 - 01/01/3000)", "Producer");
	...
	public void addRiskInformation() throws InterruptedException {
		...
		click(driver, Save_WIP, "Save WIP"); // not in test, might be needed
	}
