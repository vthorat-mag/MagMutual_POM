...
public class SmokeTestCasesUpdated extends ExtentReporter {
	 ...
	 * , groups = { "Smoke Test" }, priority = 0) public void TC42239() throws
	 * Exception { LoginPageDTO lpDTO = new
	 * LoginPageDTO(TestCaseDetails.testDataDictionary); LoginPage loginpage = new
	 * LoginPage(driver); RateApolicyPage rateapolicyPage = new
	 ...
	 * public void TC42253() throws Exception { LoginPageDTO lpDTO = new
	 * LoginPageDTO(TestCaseDetails.testDataDictionary); LoginPage loginpage = new
